...
export const staticSeoRoutes = [
  ...
  { path: '/pre-rendez-vous/', title: 'Pré-rendez-vous implantologie ou orthodontie | Dr Abdessadok', description: 'Demandez un pré-rendez-vous téléphonique gratuit de 5 minutes en implantologie ou en orthodontie invisible.', h1: 'Commençons par vous écouter.', type: 'preAppointment', indexable: false, source: 'src/pages/PreAppointment.jsx' },
]
