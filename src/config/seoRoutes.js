...
export const staticSeoRoutes = [
  ...
  { path: '/gallery/', title: 'Galerie visuelle des parcours dentaires | Dr Abdessadok', description: 'Galerie visuelle du cabinet dentaire à Sète : illustrations signalées des parcours en implantologie, orthodontie invisible et technologie.', h1: 'Voir pour mieux comprendre.', type: 'gallery', source: 'src/pages/Gallery.jsx' },
