export const generatedOrthodontiePillars = [
  {
    ...
    "faq": [
      ...
      {
        "question": "L’orthodontie concerne-t-elle aussi les adultes ?",
        "answer": "Oui. De nombreux adultes consultent pour parler d’alignement dentaire, soit parce qu’ils n’avaient jamais traité le sujet auparavant, soit parce que leurs dents ont évolué avec le temps. L’âge seul ne permet pas de conclure : l’évaluation clinique reste déterminante."
      },
      {
        "question": "Des dents chevauchées nécessitent-elles toujours un traitement ?",
        "answer": "Non. Un chevauchement doit être apprécié dans son contexte. Il peut être surtout esthétique, plus ou moins marqué, stable ou évolutif. Un bilan permet de savoir si une correction peut être envisagée ou si aucune démarche particulière n’est nécessaire."
      },
      {
        "question": "Un espace entre les dents peut-il justifier un bilan ?",
        "answer": "Oui, surtout s’il gêne le patient, s’il paraît évoluer ou s’il s’inscrit dans une question plus globale d’équilibre du sourire. Le praticien pourra préciser si cet espace relève ou non d’une discussion orthodontique."
      },
      {
        "question": "Que faire si les dents rebougent après un appareil ?",
        "answer": "Il est utile de faire évaluer la situation. Une récidive peut être légère ou plus importante. Le bilan permet d’observer les changements, d’écouter la gêne ressentie et de déterminer si une correction complémentaire peut être discutée."
      },
      {
        "question": "Le premier rendez-vous oblige-t-il à commencer un traitement ?",
        "answer": "Non. Le premier bilan sert à faire le point. Il peut déboucher sur une proposition, sur la nécessité d’examens complémentaires, sur une autre priorité de soins ou simplement sur une information plus claire sans décision immédiate."
      },
      {
        "question": "Peut-on parler d’orthodontie invisible lors d’un bilan ?",
        "answer": "Oui, lorsque le patient s’interroge sur une solution plus discrète. Le praticien peut expliquer si cette piste semble pertinente à étudier selon la situation clinique. La décision dépend de l’indication, pas uniquement de la préférence pour un dispositif."
      },
      {
        "question": "Pourquoi le suivi local compte-t-il ?",
        "answer": "Lorsqu’un traitement est engagé, il s’inscrit dans le temps et nécessite un accompagnement. Pouvoir être suivi à Sète, notamment lorsqu’on vit dans le Bassin de Thau, peut rendre le parcours plus simple à intégrer au quotidien."
      },
      {
        "question": "Peut-on consulter si l’on habite autour du Bassin de Thau ?",
        "answer": "Oui. Les patients de Sète et des communes voisines comme Mèze, Frontignan, Balaruc-les-Bains, Marseillan ou Agde peuvent prendre contact avec le cabinet pour faire le point sur leur situation."
      },
      {
        "question": "À quoi sert l’analyse de l’occlusion ?",
        "answer": "Elle permet d’observer comment les dents du haut et du bas se rencontrent. Cette relation peut être importante dans l’évaluation globale d’un désalignement et dans la réflexion sur une éventuelle correction."
      },
      {
        "question": "Faut-il avoir mal pour consulter ?",
        "answer": "Non. Les demandes autour de l’orthodontie concernent souvent l’alignement, l’esthétique du sourire, la récidive après un ancien traitement ou une gêne d’entretien. L’absence de douleur n’empêche pas de demander un avis."
      },
      {
        "question": "Le praticien peut-il dire si un traitement est pertinent dès le premier bilan ?",
        "answer": "Le bilan permet souvent d’orienter la discussion et de préciser si une démarche semble envisageable. Selon la complexité de la situation, des examens complémentaires peuvent toutefois être nécessaires avant de conclure plus finement."
      },
      {
        "question": "Une correction d’alignement peut-elle s’intégrer dans un projet de soin plus global ?",
        "answer": "Parfois, oui. Dans certaines situations, l’alignement des dents est étudié avec d’autres objectifs de soin ou de restauration. Cela dépend du contexte clinique et de la stratégie retenue par le praticien."
      },
      {
        "question": "Est-ce normal de ne pas savoir quel traitement demander en arrivant ?",
        "answer": "Oui. Le patient vient avec une question ou une gêne ; il n’a pas besoin d’arriver avec la solution déjà choisie. Le rôle du bilan est justement d’aider à clarifier les options possibles. "
      }
    ],
    "ctaSections": [
      {
        "heading": "CTA intermédiaire après la section “Orthodontie visible, orthodontie invisible”",
        "text": "Vous hésitez entre une simple question d’alignement et une solution plus discrète ?   Un bilan permet de distinguer ce qui relève de votre demande, de votre situation clinique et des options qui pourraient être discutées. Lien secondaire : Découvrir l’orthodontie invisible à Sète",
        "buttons": [
          {
  ...
  },
  {
    ...
    "faq": [
      {
        "question": "Qu’est-ce que l’orthodontie invisible ?",
        "answer": "L’orthodontie invisible désigne couramment des traitements d’alignement dentaire plus discrets, notamment par aligneurs transparents. Le principe consiste à corriger progressivement certaines positions dentaires lorsque l’indication clinique le permet."
      },
      {
        "question": "Invisalign et aligneurs transparents, est-ce la même chose ?",
        "answer": "Invisalign est un nom très connu du grand public. Les aligneurs transparents désignent plus largement une catégorie de dispositifs. Lors d’un bilan, le praticien pourra préciser les termes et le système discuté dans votre situation."
      },
      {
        "question": "Tout le monde peut-il porter des aligneurs ?",
        "answer": "Non. La pertinence dépend du type de désalignement, de la fermeture dentaire, de la santé bucco-dentaire et de la capacité à suivre les consignes de port. Un bilan est indispensable."
      },
      {
        "question": "Peut-on consulter à Sète pour savoir si le traitement est possible ?",
        "answer": "Oui. Le Cabinet Dentaire Dr. Abdessadok à Sète peut réaliser un premier bilan pour comprendre votre demande et déterminer si une discussion autour de l’orthodontie invisible est pertinente."
      },
      {
        "question": "Les aligneurs sont-ils adaptés aux adultes ?",
        "answer": "Ils peuvent être discutés chez l’adulte lorsque l’indication le permet. L’âge seul ne suffit pas à conclure ; l’état clinique global et les objectifs du patient sont essentiels."
      },
      {
        "question": "Et aux adolescents ?",
        "answer": "La question peut être posée, mais la décision dépend du cas et de la capacité du jeune à respecter un port régulier. Tous les adolescents ne sont pas automatiquement de bons candidats."
      },
      {
        "question": "Faut-il retirer les aligneurs pour manger ?",
        "answer": "Les aligneurs sont généralement retirés pendant les repas. Le praticien précisera les consignes pratiques à respecter dans le cadre du traitement proposé."
      },
      {
        "question": "Les aligneurs gênent-ils pour parler ?",
        "answer": "Une courte phase d’adaptation peut exister chez certains patients. Elle varie d’une personne à l’autre et tend souvent à diminuer à mesure que le patient s’habitue au dispositif."
      },
      {
        "question": "Combien de temps dure le traitement ?",
        "answer": "La durée dépend de la situation clinique, des mouvements nécessaires, de la stratégie retenue et de la régularité du port. Une estimation pertinente ne peut être donnée qu’après évaluation."
      },
      {
        "question": "Pourquoi la durée varie-t-elle ?",
        "answer": "Parce que tous les désalignements ne demandent pas les mêmes corrections et que le traitement dépend aussi du suivi, de l’évolution observée et de la coopération du patient."
      },
      {
        "question": "Que se passe-t-il au premier bilan ?",
        "answer": "Le praticien écoute votre demande, examine l’alignement, évalue le contexte bucco-dentaire et précise si une orthodontie invisible peut être discutée. Des examens complémentaires peuvent être envisagés selon la situation."
      },
      {
        "question": "Peut-on parler du budget au premier rendez-vous ?",
        "answer": "Oui, mais le budget dépend du cas. Le bilan permet de comprendre quels paramètres influencent la proposition de traitement. Une page dédiée peut également apporter des repères généraux sur le prix."
      },
      {
        "question": "Le traitement est-il discret au quotidien ?",
        "answer": "Les aligneurs transparents sont recherchés pour leur discrétion. Toutefois, leur visibilité réelle peut varier selon les situations et l’équipement nécessaire. Le praticien pourra préciser ce à quoi s’attendre."
      },
      {
        "question": "Que faire si l’on a déjà porté un appareil ?",
        "answer": "Il est fréquent de consulter après une récidive. Le bilan permet d’évaluer ce qui a évolué et de déterminer si une nouvelle correction peut être envisagée."
      },
      {
        "question": "Pourquoi le suivi à Sète compte-t-il ?",
        "answer": "Parce qu’un traitement invisible reste un traitement orthodontique nécessitant un accompagnement. Le suivi local facilite les échanges, les contrôles et la compréhension des étapes."
      },
      {
        "question": "Où trouver les explications sur le prix ?",
        "answer": "Une page spécifique détaille les éléments qui influencent le coût d’une orthodontie invisible à Sète : `/prix-orthodontie-invisible-sete`."
      },
      {
        "question": "Le traitement invisible est-il forcément plus simple qu’un autre ?",
        "answer": "Non. Il peut être plus discret et plus souple sur certains aspects du quotidien, mais il demande une vraie rigueur de port et une évaluation clinique sérieuse."
      },
      {
        "question": "Peut-on demander un bilan sans être sûr de vouloir commencer ?",
        "answer": "Oui. Le bilan sert justement à obtenir une information individualisée, à comprendre les options possibles et à prendre une décision plus sereine. "
      }
    ],
    "ctaSections": [
      {
        "heading": "CTA intermédiaire après la section “Suis-je un bon candidat ?”",
        "text": "Vous ne savez pas si les aligneurs peuvent convenir à votre situation ?   Un bilan au cabinet permet de distinguer une simple curiosité, une demande réellement pertinente et les options à discuter selon l’examen clinique.",
        "buttons": [
          {
            "label": "Demander un bilan",
            "href": "/contact"
      ...
      {
        "heading": "CTA intermédiaire après la section “Prix, devis et remboursement”",
        "text": "Vous souhaitez comprendre ce qui influence le coût d’un traitement invisible ?   Consultez la page dédiée au prix, puis demandez un bilan pour obtenir une réponse liée à votre propre situation.",
        "buttons": [
          {
